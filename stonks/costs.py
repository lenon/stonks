...
def sum_confirmation_volume_and_costs(confirmations):
...
def calc_trade_net_amount(trades):
    return trades.apply(
...
# one or more trades.
def calc_trade_amount_and_costs(confirmations, trades):
    conf_prefix = "c_"
    ...
    return (
        ...
        .assign(
            ...
            net_amount=calc_trade_net_amount,
        )
...
def calc_subscription_net_amount(subscriptions):
